  ...
  return (
    <aside className="hidden border border-[#fafafa]/10 bg-[#111111] p-4 lg:block">
      ...
      <div className="mt-6 space-y-1">
        {actions.map((item) => (
          <Link key={item.label} to={item.to} className={`flex h-10 items-center justify-between border px-3 text-[13px] transition ${item.label === 'My rooms' ? 'border-[#fafafa]/12 bg-[#fafafa]/6 text-[#fafafa]' : 'border-transparent text-[#fafafa]/62 hover:border-[#fafafa]/10 hover:bg-[#fafafa]/5 hover:text-[#fafafa]'}`}>
