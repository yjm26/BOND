...
export default function RoomPartiesPanel({ room, isCreator, isCounter, creatorRep, counterpartyRep, role }) {
  ...
  return (
    <div className="border border-[#fafafa]/10 bg-[#111111] p-5">
      <div className="mb-4 font-mono text-[10px] uppercase tracking-[0.22em] text-[#fafafa]/40">Parties</div>
      <div className="grid gap-3">
        ...
        {room.counterparty !== '0x0000000000000000000000000000000000000000' ? (
          ...
          <div className="border border-dashed border-[#fafafa]/14 bg-[#0a0a0a] p-4 text-[13px] text-[#a3a3a3]">Waiting for counterparty to join…</div>
        )}
      </div>
      <div className="mt-4 border-t border-[#fafafa]/10 pt-4 text-[13px] text-[#a3a3a3]">Your role: <span className="text-[#fafafa]">{role || 'Viewer'}</span></div>
    </div>
  )
}
