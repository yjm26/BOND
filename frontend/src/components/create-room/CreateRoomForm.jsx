...
const inputClass = 'h-12 w-full border border-[#fafafa]/12 bg-[#0a0a0a] px-4 text-[14px] text-[#fafafa] outline-none transition placeholder:text-[#fafafa]/24 focus:border-[#a3a3a3]/60 disabled:cursor-not-allowed disabled:opacity-60'
...
export default function CreateRoomForm({ state, setters, fromMarket, canSubmit, loading, step, error, onRequestCreate }) {
  ...
  return (
    <div className="border border-[#fafafa]/10 bg-[#111111] p-5 sm:p-6">
      <div className="mb-5 font-mono text-[10px] uppercase tracking-[0.22em] text-[#fafafa]/40">Room terms</div>
      <div className="grid gap-5">
        ...
        <button onClick={onRequestCreate} disabled={loading || !canSubmit} className="h-12 border border-[#fafafa] bg-[#fafafa] px-5 font-mono text-[11px] font-semibold uppercase tracking-[0.16em] text-[#111111] transition hover:bg-transparent hover:text-[#fafafa] disabled:cursor-not-allowed disabled:opacity-40">
