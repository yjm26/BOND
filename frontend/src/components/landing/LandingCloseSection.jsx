  ...
  return (
    <section className="border-t border-[#0a0a0a]/10 bg-[#fafafa] px-4 py-12 text-[#0a0a0a] sm:px-10 sm:py-14 lg:px-14">
      <div className="mx-auto max-w-[1080px]">
        ...
        <h2 className="mt-3 max-w-[16ch] text-balance text-[clamp(28px,4vw,40px)] font-medium leading-[1.05] tracking-[-0.05em]">
          Start here.
        </h2>
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 font-mono text-[10px] uppercase tracking-[0.16em] text-[#0a0a0a]/45 transition-colors duration-160 group-hover:text-[#0a0a0a]">
              App <span className="inline-block transition-transform duration-200 ease-out group-hover:translate-x-0.5">→</span>
            </div>
          </Link>
          ...
          >
            ...
            <div className="mt-5 font-mono text-[10px] uppercase tracking-[0.16em] text-[#fafafa]/50 transition-colors duration-160 group-hover:text-[#0a0a0a]">
              Market <span className="inline-block transition-transform duration-200 ease-out group-hover:translate-x-0.5">→</span>
            </div>
          </Link>
        </div>
      </div>
