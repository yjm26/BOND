...
export default function MarketListings({ loading, listings, search, wallet, onOpenDeal, onDelete, onExpand, onPostListing }) {
  if (loading) {
  ...
  if (listings.length === 0) return <MarketEmptyState search={search} wallet={wallet} onPostListing={onPostListing} />
