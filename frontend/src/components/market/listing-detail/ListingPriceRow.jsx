export default function ListingPriceRow({ listing }) {
  ...
  return (
    <div className="grid grid-cols-2 border border-[var(--a-line)] bg-[var(--a-bg)]">
      <div className="border-r border-[var(--a-line)] p-4">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          <span className="font-mono text-[34px] leading-none tracking-[-0.05em] text-[var(--a-ink)]">{listing.price}</span>
      ...
      <div className="p-4">
        ...
        <div className={`mt-3 font-mono text-[15px] font-semibold ${hasCollateral ? 'text-[var(--a-muted)]' : 'text-[color:var(--a-faint)]'}`}>
