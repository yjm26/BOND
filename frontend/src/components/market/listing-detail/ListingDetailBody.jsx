  ...
  return (
    <div className="grid gap-3 p-4 sm:grid-cols-[1fr_320px] sm:p-5">
      ...
      <div className="grid content-start gap-3">
        ...
        <div className="flex items-center justify-between border border-[var(--a-line)] bg-[var(--a-surface)]/55 px-3 py-2.5">
          <span className="font-mono text-[9px] uppercase tracking-[0.18em] text-[color:var(--a-faint)]">Listing expiry</span>
          <span className="font-mono text-[11px] uppercase tracking-[0.14em] text-[var(--a-ink)]">{listingExpiryLabel(listing)}</span>
        </div>
        <div className="border border-[var(--a-muted)]/16 bg-[var(--a-muted)]/[0.045] p-3">
          <div className="font-mono text-[9px] uppercase tracking-[0.18em] text-[var(--a-muted)]">Settlement path</div>
