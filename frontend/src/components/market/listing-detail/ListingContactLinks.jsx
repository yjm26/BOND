    ...
    <div className="border border-[var(--a-line)] bg-[var(--a-surface,#111111)]/55 p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {SOCIAL_OPTIONS.map((social) => {
          ...
          const className = "inline-flex items-center gap-1.5 border border-[var(--a-line)] px-3 py-1.5 text-[12px] text-[#e5e5e5] transition hover:border-[var(--a-muted,#a3a3a3)]/34 hover:text-[var(--a-ink,#fafafa)]"
