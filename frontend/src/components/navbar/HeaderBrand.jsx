...
export default function HeaderBrand({ tone = 'light' }) {
  ...
  return (
    <Link to="/" className="group inline-flex items-center gap-3">
      ...
      <span>
        ...
        <span className={`hidden font-mono text-[9px] uppercase tracking-[0.22em] sm:block ${dark ? 'text-[#ede9df]/56' : 'text-[#0d0d0b]/55'}`}>Escrow rooms on Arc</span>
      </span>
    </Link>
  )
}
