  ...
  if (!disputes.length) {
    return (
      <div className="border border-[var(--a-line)] bg-[var(--a-surface)] p-8 text-center">
        ...
        <h2 className="mt-4 text-[34px] font-medium leading-none tracking-[-0.06em] text-[var(--a-ink)]">
          No disputed rooms.
        </h2>
        <p className="mx-auto mt-3 max-w-[420px] text-[13px] leading-[1.7] text-[var(--a-muted)]">
          When a buyer disputes or a seller escalates no response, the room will appear here for arbiter review.
        </p>
      </div>
    )
  }
