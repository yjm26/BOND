const NODE_TONES = {
  accent: 'border-[#d8b15f] bg-[#d8b15f] shadow-[0_0_30px_rgba(216,177,95,0.42)]',
  active: 'border-[#b7c8a3] bg-[#b7c8a3] shadow-[0_0_30px_rgba(183,200,163,0.42)]',
  muted: 'border-[#c98b4a]/70 bg-[#c98b4a]/30',
  ...
  return (
    <div className="absolute -translate-x-1/2 -translate-y-1/2" style={{ left: node.x, top: node.y }}>
      <div className="group relative">
        ...
        <div className={`absolute z-20 min-w-[145px] border border-[#ede9df]/15 bg-[#20201f]/86 px-3 py-2 backdrop-blur transition duration-300 ease-out group-hover:min-w-[220px] group-hover:border-[#d8b15f]/55 group-hover:bg-[#20201f]/96 ${LABEL_POSITIONS[node.align || 'right']}`}>
