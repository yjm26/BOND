    ...
    <div className="w-full max-w-[1080px]">
      <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between lg:gap-12">
        <div className="min-w-0 max-w-[720px]">
          <h1 className="text-[clamp(36px,5.5vw,64px)] font-medium leading-[1.02] tracking-[-0.055em] text-[#0a0a0a]">
            Lock USDC.
            <br />
            Settle the deal.
          </h1>
          <p className="mt-5 max-w-[420px] text-[15px] leading-[1.55] tracking-[-0.01em] text-[#525252]">
