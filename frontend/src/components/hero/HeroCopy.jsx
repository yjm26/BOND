  ...
  return (
    <div className="relative flex w-full flex-col px-6 py-8 sm:px-10 lg:px-16 lg:py-16 xl:px-20">
      <div className="w-full pt-6 sm:pt-10 lg:pt-[8vh] xl:pt-[10vh]">
        ...
        <h1 className="max-w-[860px] text-[clamp(76px,18vw,220px)] font-medium leading-[0.82] tracking-[-0.1em] text-[#0d0d0b] sm:text-[clamp(92px,15vw,190px)] sm:leading-[0.8] sm:tracking-[-0.105em]">
          BOND
        </h1>
