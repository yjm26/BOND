    ...
    <section id="use-cases" className="bg-[#ede9df] px-6 pb-16 text-[#171716] sm:px-10 sm:pb-28 lg:px-14">
      <div className="border-y border-[#171716]/15 py-8 sm:py-10">
        <div className="grid gap-8 lg:grid-cols-[38%_1fr] lg:items-end">
          <div>
            <div className="font-mono text-[10px] uppercase tracking-[0.28em] text-[#6f6b62]">Where it fits</div>
            <h2 className="mt-5 max-w-[560px] text-[clamp(40px,5vw,72px)] font-medium leading-[0.9] tracking-[-0.085em] text-[#171716]">
              Not every deal needs BOND. The awkward ones do.
            </h2>
          </div>
          <p className="max-w-[660px] text-[15px] leading-[1.72] tracking-[-0.01em] text-[#5f5a50] lg:justify-self-end">
