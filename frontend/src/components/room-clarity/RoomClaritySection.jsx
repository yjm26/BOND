...
export default function RoomClaritySection() {
  return (
    <section className="bg-[#ede9df] px-6 py-24 text-[#171716] sm:px-10 lg:px-14 lg:py-28">
      <div className="grid gap-14 lg:grid-cols-[34%_1fr] lg:gap-12">
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <div className="mt-10 border-t border-[#171716]/15 pt-4 font-mono text-[10px] uppercase leading-[1.8] tracking-[0.18em] text-[#6f6b62]">
