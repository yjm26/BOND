...
export default function AppHome({ wallet, profile }) {
  ...
  return (
    <section className="min-h-screen bg-[var(--a-bg,#000000)] px-4 pt-[88px] pb-6 text-[var(--a-ink,#fafafa)] sm:px-6 lg:px-8">
      <div className="pb-0">

        <main className="flex flex-col overflow-hidden border border-[var(--a-line)] bg-[var(--a-panel,#0a0a0a)]">
          <div className="border-b border-[var(--a-line)] p-5 sm:p-6 lg:p-7">
            <div className="font-mono text-[10px] uppercase tracking-[0.28em] text-[var(--a-muted,#a3a3a3)]">Home</div>
          ...
          <div className="grid gap-4 p-4 sm:p-5 lg:grid-cols-2 lg:p-5">
            ...
            <div className="border border-[var(--a-line-strong)] bg-[var(--a-chip)] p-5 sm:p-6">
              <div className="font-mono text-[10px] uppercase tracking-[0.22em] text-[var(--a-muted,#a3a3a3)]">Arc Testnet</div>
