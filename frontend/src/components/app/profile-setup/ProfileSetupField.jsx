  ...
  return (
    <>
      ...
      <label className="mt-10 block">
        <span className="font-mono text-[10px] uppercase tracking-[0.22em] text-[color:var(--a-faint)]">{step.label}</span>
        {step.note && <span className="mt-2 block text-[12px] leading-[1.55] text-[color:var(--a-faint)]">{step.note}</span>}
        <input
          autoFocus
          value={value}
