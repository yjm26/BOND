export default function ProfileSetupActions({ canContinue, isFirstStep, isLastStep, onBack }) {
  return (
    <div className="mt-8 grid grid-cols-[0.8fr_1.2fr] gap-2">
      ...
      <button disabled={!canContinue} className="h-12 border border-[var(--a-ink,#fafafa)] bg-[var(--a-inverse-bg,#fafafa)] font-mono text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--a-inverse-ink,#0a0a0a)] transition hover:bg-transparent hover:text-[var(--a-ink,#fafafa)] disabled:cursor-not-allowed disabled:opacity-40">
