export default function WorkspaceLoading({ label = 'Preparing workspace' }) {
  return (
    <section className="min-h-screen overflow-hidden bg-[var(--a-bg)] px-6 pt-[96px] text-[var(--a-ink)] sm:px-10 lg:px-14">
      <div className="relative flex min-h-[calc(100vh-96px)] items-center justify-center">
        ...
        <div className="absolute h-[420px] w-[420px] rounded-full bg-[var(--a-muted)]/10 blur-3xl" />
        <div className="relative w-full max-w-[460px] border border-[var(--a-line)] bg-[var(--a-surface)]/80 p-6 text-center sm:p-8">
          ...
          <div className="mt-6 font-mono text-[10px] uppercase tracking-[0.28em] text-[var(--a-muted)]">{label}</div>
          <p className="mt-3 text-[15px] leading-[1.6] text-[var(--a-muted)]">
