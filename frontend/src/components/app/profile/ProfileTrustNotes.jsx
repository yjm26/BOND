export default function ProfileTrustNotes() {
  return (
    <div className="border border-[var(--a-line)] bg-[var(--a-surface,#111111)] p-5 sm:p-6">
      <div className="font-mono text-[10px] uppercase tracking-[0.22em] text-[var(--a-ink,#fafafa)]/40">Trust notes</div>
      <div className="mt-5 grid gap-3 text-[13px] leading-[1.65] text-[var(--a-muted,#a3a3a3)]">
